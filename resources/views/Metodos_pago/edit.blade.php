...
<table >
  <tr>
    ...
    {!! Form::open([ 'method' => 'PATCH' , 'url'=>'/metodos_pago/'.$metodo_pago->id]) !!}

        {!! Form::label ('forma_pago','Dame la forma de pago') !!}
        {!! Form::text ('forma_pago',$metodo_pago ->forma_pago,['placeholder'=>'Ingresa froma de pago']) !!}
        <br />
        @error('forma_pago')
